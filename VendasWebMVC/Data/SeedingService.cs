...
namespace VendasWebMVC.Data
{
    public class SeedingService
    {
        ...
        //Quando um SeedingService for instânciado, automaticamente ele recebe uma
        ...
        //Método para Popular a base de Dados
        public void Seed()
        {   //Verifica se existe algum registro nas Tabelas
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any() )
            {
                return; //Corta Execução do método e não faz mais nada
            }
